...
export default function CreateAccount({ setLoading }) {
    ...
    const handleSubmit = async (formValues) => {
        ...
        formDataToSend.append('className', formValues.role === 'Teacher' ? 'GV K. ' + formValues.faculty : formValues.class);
        ...
        setLoading(true);
        try {
            const res = await axios.post('http://localhost:5148/api/account/register', formDataToSend);
            setModal({
                isShow: true,
