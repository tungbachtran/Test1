...
export default function CourseInChargeDetail({ setLoading }) {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            let { data: scoreData } = await axios.get(`http://localhost:5148/api/score/class/${courseClassId}`);
            const formattedScore = scoreData.map((item) => {
                ...
                return {
                    ...
                    scoreBT: item.score.excerciseScore !== null ? item.score.excerciseScore.toFixed(1) : null,
                    scoreGK: item.score.midTermScore !== null ? item.score.midTermScore.toFixed(1) : null,
                    scoreCK: item.score.finalTermScore !== null ? item.score.finalTermScore.toFixed(1) : null,
